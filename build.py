...
def get_personal_data():
    name = ["Christian", "Tchenko"]
    email = "yanickchristian@gmx.de"
    twitter = "Christian Tchenko"
    github = "TheAnimal03"
    linkedin = "Christian Tchenko"
    bio_text = f"""
                ...
                <p>
                    ...
                    I am PhD student at the <a href="https://www.universite-paris-saclay.fr/ecoles-doctorales/sciences-et-technologies-de-linformation-et-de-la-communication-stic#edit-group-doctorat" target="_blank">Max Planck Insitute for Intelligent Systems</a> supervised by <a href="https://www.ibisc.univ-evry.fr/membre/235/" target="_blank">Hedi Tabia</a>.
                    As an undergraduate student, I received a B.Ing. in Mechatronics from the <a href="https://www.hshl.de/studieren/studiengaenge/bachelorstudiengaenge/mechatronik/" target="_blank">Hamm-Lippstadt University of Applied Sciences (Germany)</a> and a MSc from the 
                    <a href="https://www.uni-due.de/studienangebote/studiengang.php?id=166" target="_blank">University of Duiburg Essen (UK)</a>.
                    <!-- In March 2023, I started my PhD in computer vision / machine learning in the <a href="https://www.ibisc.univ-evry.fr/en/" target="_blank">AVG group</a> at the <a href ="https://is.mpg.de/" target="_blank">Max Planck Institute for Intelligent Systems</a> in Tübingen, Germany, under the supervision of <a href="http://www.accis.universite-paris-saclay.fr/index.php?option=com_content&view=article&id=87:prof-samia-bouchafa&catid=27&Itemid=114" target="_blank">Samia Bouchafa-Bruneau</a>.  -->
                </p>
                # <p>
